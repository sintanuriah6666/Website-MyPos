...
<head>
	...
	<link rel="icon" href="<?=base_url('assets/dist/img/alice.png')?>">
	...
	<div class="wrapper">
		<header class="main-header">
			<a href="<?=base_url('dashboard')?>" class="logo">
				<span class="logo-mini">st<b>ore</b></span>
				<span class="logo-lg"><b>A L I C E</b></span>
			</a>
				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img src="<?=base_url()?>assets/dist/img/alice.png" class="user-image">
								<span class="hidden-xs"><?=$this->fungsi->user_login()->username?></span>
							</a>
							<ul class="dropdown-menu">
								<li class="user-header">
									<img src="<?=base_url()?>assets/dist/img/alice.png" class="img-square">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview <?=$this->uri->segment(1) == 'category' || $this->uri->segment(1) == 'unit' || $this->uri->segment(1) == 'item' ? 'active' : ''?>">
						...
						<ul class="treeview-menu">
							...
							<li <?=$this->uri->segment(1) == 'stock' ? 'class="active"' : ''?>><a href="<?=site_url('stock/out')?>"><i class="fa fa-circle-o"></i>Stock Out</a></li>
					...
					<li class="treeview" <?=$this->uri->segment(1) == 'report'  ? 'active' : ''?>">
						...
						<ul class="treeview-menu">
							...
							<a href="<?=site_url('report/stocks')?>"><i class="fa fa-circle-o"></i>Stocks</a>
